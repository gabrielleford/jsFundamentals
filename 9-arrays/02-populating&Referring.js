...
// food = food.slice(2, 4); // the first number is the first element to slice away from the array, while the second number is the stop position (not to be included)
// console.log(food);
